...
interface ToastProps{
  ...
  delay: Number;
  hideOnPress: Boolean;
  siblingManager: Object;
  onPress():void;
  onHide(siblingManager:any):void;
  onHidden(siblingManager:any):void;
  onShow(siblingManager:any):void;
  onShown(siblingManager:any):void;
}
...
class Toast extends Component<ToastProps,ToastState> {
  ...
  render() {
    ...
    // @ts-ignore
    const keyboardHeight:any = Math.max(windowHeight - keyboardScreenY, 0);
    let position = offset ? {
      // @ts-ignore
